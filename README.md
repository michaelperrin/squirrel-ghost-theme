...
## Init
    ...
    docker-compose exec ghost sh -c 'cd /var/lib/ghost/content/themes/squirrel-ghost-theme && yarn'

## Dev

    docker-compose exec ghost sh -c 'cd /var/lib/ghost/content/themes/squirrel-ghost-theme && yarn dev'

## ZIP

    docker-compose exec ghost sh -c 'cd /var/lib/ghost/content/themes/squirrel-ghost-theme && yarn zip'
